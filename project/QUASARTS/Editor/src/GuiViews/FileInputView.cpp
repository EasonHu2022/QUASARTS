                        ...
                        if (ImGui::Selectable(assetsFiles[j].path().filename().string().c_str(), selected == j, ImGuiSelectableFlags_AllowDoubleClick)) {
                            ...
                            if (ImGui::IsMouseDoubleClicked(0)) {
                                if (i == 0) {
                                    ...
                                    //material.material = new Engine::Material("E:\\project\\QUASARTS\\project\\QUASARTS\\Engine\\src\\Shader\\DefaultShader.vsh", "E:\\project\\QUASARTS\\project\\QUASARTS\\Engine\\src\\Shader\\DefaultShader.fsh");
                                    material.material = new Engine::Material("E:\\project\\QUASARTS\\project\\QUASARTS\\Engine\\src\\Shader\\DefaultShader.vsh", "E:\\project\\QUASARTS\\project\\QUASARTS\\Engine\\src\\Shader\\DefaultShader.fsh");
